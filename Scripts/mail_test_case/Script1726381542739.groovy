...
try {
	...
	String emailBody = "Please find the attached test results from the latest automation run for ls soundbar in amazon for single page as well as for all pages.\n\n"
	emailBody += "You can check the project details on GitHub: https://github.com/aditya1123mp/amazon_project_for_contlo"
